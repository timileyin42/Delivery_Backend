"""
Django settings for Delivery Backend project.
"""
...
MIDDLEWARE = [
    ...
    'config.middleware.RequestLoggingMiddleware',  # Custom middleware
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Internal Logistics Platform API',
    'DESCRIPTION': 'Backend API for managing delivery operations in Lagos',
    'VERSION': '1.0.0',
...
# Resend Email Service (Primary Email Backend)
RESEND_API_KEY = config('RESEND_API_KEY', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@logistics.com')
FRONTEND_URL = config('FRONTEND_URL', default='http://localhost:3000')

# Django email backend (for password reset built-in views if needed)
# Using console backend for development, can be changed to SMTP if needed
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.console.EmailBackend')

# Termii SMS Service
TERMII_API_KEY = config('TERMII_API_KEY', default='')
TERMII_SENDER_ID = config('TERMII_SENDER_ID', default='LOGISTICS')
